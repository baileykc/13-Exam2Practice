...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        if len(contents) <= volume:
            ...
            self.contents = ''
        self.intial_contents = self.contents
        self.intial_volume = self.volume
        self.history = []
    ...
    def double_then_shrink(self, new_volume):
        ...
        return double + len(self.shrink(new_volume))
    ...
    def reset(self):
        ...
        self.contents = self.intial_contents
        self.volume = self.intial_volume
